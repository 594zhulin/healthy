<template>
	<view class="page-detail" :style="{ paddingBottom: bottom + 'px' }">
		<view class="status-content">
			...
			<view class="text" v-if="orderDetail._status._type == -1">退款中</view>
			<view class="text" v-if="orderDetail._status._type == -2">已退款</view>
			...
			<image v-if="orderDetail._status._type == -2||orderDetail._status._type == -1" class="icon" src="../../static/order/order-icon-05.svg"
		...
		<view class="address-content">
			<view class="logistics" v-if="orderDetail._status._type == 2" @click="navigateTo('/pages/order/logistics?id=' + orderDetail.order_id)">
				...
				<view class="content">
					...
					<view class="date">{{ orderDetail._status._msg }}</view>
				</view>
		...
		<view class="product-content" v-if="orderDetail">
		...
		<view v-if="orderDetail._status._type != -2&&orderDetail._status._type != -1" id="bottom" class="btn-content" :style="{ paddingBottom: isIphoneX ? paddingBottom : '20rpx' }">
			<template v-if="orderDetail._status._type == 0">
			...
			<template v-if="orderDetail._status._type == 2">
				...
				<view class="btn" @click="takeOrder(orderDetail.order_id)">确认收货</view>
			</template>
