<template>
	<view class="page-detail" :style="{ paddingBottom: bottom + 'px' }">
		...
		<view v-if="orderDetail._status._type != -1" id="bottom" class="btn-content" :style="{ paddingBottom: isIphoneX ? paddingBottom : '20rpx' }">
			<template v-if="orderDetail._status._type == 0">
...
<script>
import { getOrderDetail, cancelOrder, payOrder, alertOrder, confirmOrder, deleteOrder, payOrderCallback } from '@/api/order.js';
export default {
	data() {
		return {
			isIphoneX: false,
