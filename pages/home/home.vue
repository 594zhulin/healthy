  ...
  <view class="page-home">
    <template v-if="isLogin">
      <view class="overview-content">
        <view class="score-item" @click="navigateTo('/pages/measure/index')">
          <image
            class="background"
            src="../../static/home/home-bg-01.svg"
            mode="aspectFit"
          ></image>
          <image
            class="icon"
            src="../../static/home/home-icon-01.svg"
            mode="aspectFit"
          ></image>
        ...
        <view class="bank-item" @click="navigateTo('/pages/bank/bank')">
          <image
            class="background"
            src="../../static/home/home-bg-02.svg"
            mode="aspectFit"
          ></image>
          <image
            class="icon"
            src="../../static/home/home-icon-02.svg"
            mode="aspectFit"
          ></image>
      ...
      <view class="grid-content">
        <view class="grid-item plan" @click="navigateTo('/pages/train/plan')">
          <image
            class="icon"
            src="../../static/home/home-icon-03.svg"
            mode="aspectFit"
          ></image>
          <view class="title">AI体能训练计划</view>
          <view class="btn" @click.stop="navigateTo('/pages/train/recommend')"
            >立即制定</view
          >
        </view>
        <view class="grid-item mall" @click="switchTab">
          <image
            class="icon"
            src="../../static/home/home-icon-04.svg"
            mode="aspectFit"
          ></image>
        ...
        <view class="grid-item diet" @click="navigateTo('/pages/diet/index')">
          <image
            class="icon"
            src="../../static/home/home-icon-05.svg"
            mode="aspectFit"
          ></image>
          <view class="title">膳食健康管理</view>
          <view class="btn" @click.stop="navigateTo('/pages/diet/one')"
            >开始评测</view
          >
        </view>
        <view class="grid-item video" @click="navigateTo('/pages/video/list')">
          <image
            class="icon"
            src="../../static/home/home-icon-06.svg"
            mode="aspectFit"
          ></image>
        ...
        <view
          class="grid-item ranking"
          @click="navigateTo('/pages/ranking/ranking')"
        >
          <image
            class="icon"
            src="../../static/home/home-icon-07.svg"
            mode="aspectFit"
          ></image>
          <view class="content">
      ...
      <view class="list-content">
        ...
        <view
          ...
          :key="item.id"
          @click="navigateTo('/pages/order/product?id=' + item.id)"
        >
          <image class="pic" :src="item.image" mode="aspectFit"></image>
          <view class="content">
            <view class="title">{{ item.store_name }}</view>
            <!-- <view class="price">原价：{{ item.ot_price }}元</view> -->
            <view class="step" v-if="item.is_model == 1"
              >{{ item.buy_credits }}万</view
            >
    ...
    <template v-else>
      <view class="login-content">
        <image
          class="logo"
          src="../../static/home/home-image-01.png"
          mode="aspectFit"
        ></image>
  ...
  methods: {
            ...
            (result) => {
              ...
              if (!result.is_news) {
                uni.showToast({
                  icon: "none",
                  title:
                    "您已经不是新用户了，无法帮Ta点亮，请督促Ta多多观测自己的身体素质吧！",
                  duration: 2000,
                });
              }
            },
    ...
    getCacheStep() {
      ...
      if (lastTime == "") {
        ...
        let diff =
          (new Date(startDate).getTime() - new Date(lastTime).getTime()) / day;
        if (diff > 7) {
          const step = this.getSum(this.step);
          const timestamp = new Date(startDate).getTime() / 1000;
          this.cacheStep(step, timestamp);
                ...
                (result) => {
                  ...
                  if (_this.isNew) {
                    uni.showToast({
                      icon: "none",
                      title:
                        "非常感谢，我已经点亮一个小火苗，你也快来吧，存步数兑礼品，还可以让身体更健康哦！",
                    });
                  }
                },
                (err) => {}
