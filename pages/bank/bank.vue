<template>
  <view class="page-bank">
    ...
    <view class="overview-content" @click="handleClick">
      <image
        class="background"
        src="../../static/bank/bank-bg-01.svg"
        mode="scaleToFill"
      ></image>
      ...
      <image
        class="btn"
        src="../../static/bank/bank-img-01.svg"
        mode="aspectFit"
      ></image>
    </view>
    ...
    <view class="desc-content">
      <image
        class="icon"
        src="../../static/bank/bank-icon-01.svg"
        mode="aspectFit"
      ></image>
      <view class="title">如何激活步数</view>
      <view class="btn">订阅提醒</view>
      <view class="text">
        <view>激活存步数的前提是您必须要有火苗，您有两种方式获得火苗：</view>
        <view
          >1、请点击下方“找黑石”按地图所示位置，去使用我们的设备，检测自己的身体素质</view
        >
        <view
          >2、通过活动蹭火苗去邀请新用户，帮忙点燃一枚小火苗，只有对方是新用户才可以哦</view
        >
      </view>
    </view>
    <view class="banner-content" @click="switchTab">
      ...
      <image
        class="background"
        src="../../static/bank/bank-img-03.png"
        mode="aspectFit"
      ></image>
      <image
        class="icon"
        src="../../static/bank/bank-img-02.png"
        mode="aspectFit"
      ></image>
    </view>
    <view class="grid-content">
      <view class="grid-item" @click="navigateTo('/pages/ranking/ranking')">
        <image
          class="icon"
          src="../../static/bank/bank-icon-02.svg"
          mode="aspectFit"
        ></image>
      ...
      <view class="grid-item">
        <image
          class="icon"
          src="../../static/bank/bank-icon-03.svg"
          mode="aspectFit"
        ></image>
    ...
    <view class="list-content">
      ...
      <view class="total">
        <view class="fire">
          <image
            class="icon"
            src="../../static/bank/bank-icon-04.svg"
            mode="aspectFit"
          ></image>
        ...
        <view class="step">
          <image
            class="icon"
            src="../../static/bank/bank-icon-05.svg"
            mode="aspectFit"
          ></image>
