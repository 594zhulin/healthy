	...
	<view class="page-bank">
		...
		<view class="desc-content">
			...
			<view class="text">
				...
				<view>1、请点击下方“找黑石”按地图所示位置，去使用我们的设备，检测自己的身体素质</view>
				<view>2、通过活动蹭火苗去邀请新用户，帮忙点燃一枚小火苗，只有对方是新用户才可以哦</view>
			</view>
		</view>
...
export default {
	...
	methods: {
		getUser() {
			...
			getUser().then(
				result => {
					const { avatarUrl, nickName, flame_num } = result;
