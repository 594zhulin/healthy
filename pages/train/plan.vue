...
import { getTrainData, getTrainList, getFitnessData, getStep } from '@/api/train.js';
export default {
	components: {
		mpvueEcharts
	},
	...
	onLoad() {
		...
		getTrainData().then(
			result => {
				const { deposit_num, pliable, force, aerobics, leisure, AI_drill_intro, AI_drill_picture } = result;
