<template>
	<view class="page-launch">
		<view class="btn-home" @click="switchTab">
			<image class="icon" src="../../static/home/home.svg" mode="aspectFit"></image>
		</view>
		<swiper class="swiper" :autoplay="true" interval="5000">
			<swiper-item class="swiper-item" v-for="(item, index) in banner" :key="index">
				<image class="banner" :src="item.ad_pic" mode="widthFix"></image>
			</swiper-item>
		</swiper>
					...
					<view class="flex-vertical has-login">
						<view class="flex-item">
							...
							<view class="flex-horizontal">
								...
								<view class="flex-item btn-item">
									<view class="btn-modify" @click="modify"></view>
								</view>
							</view>
						</view>
						<view class="flex-item">
							<view class="btn-start" @click="start">启动设备</view>
						</view>
					</view>
				</block>
				<block v-else>
